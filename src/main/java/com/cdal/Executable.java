...
public class Executable {
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        Athlete athlete34 = new Athlete("Laurent", "Emma", 'F', 11, 14, 16, usa,  new Equipe("Laurent Emma"));
        fleretH.ajouterResultat(athlete34, new Score(11, 4,  athlete34));
        Athlete athlete35 = new Athlete("Garcia", "Arthur", 'M', 1, 20, 17, usa,  new Equipe("Garcia Arthur"));
        volleyF.ajouterResultat(athlete35, new Score(10, 1,  athlete35));
        Athlete athlete36 = new Athlete("Petit", "Gabriel", 'M', 20, 5, 10, turquie,  new Equipe("Petit Gabriel"));
        epeeH.ajouterResultat(athlete36, new Score(19, 4,  athlete36));
        Athlete athlete37 = new Athlete("Meier", "Tom", 'F', 19, 18, 17, france,  new Equipe("Meier Tom"));
        epeeF.ajouterResultat(athlete37, new Score(13, 5,  athlete37));
        Athlete athlete38 = new Athlete("Sakamoto", "Haruto", 'F', 9, 20, 20, australie,  new Equipe("Sakamoto Haruto"));
        haiesF.ajouterResultat(athlete38, new Score(17, 2,  athlete38));
        Athlete athlete39 = new Athlete("Wang", "Chen", 'M', 9, 16, 5, maroc,  new Equipe("Wang Chen"));
        handF.ajouterResultat(athlete39, new Score(6, 5,  athlete39));

        /** Création d'une équipe + Ajout de résultats */
        Equipe equipe1 = new Equipe("Equipe Number ONE");
        Athlete athlete40 = new Athlete("Bernard", "Gabriel", 'F', 6, 10, 8, france,  equipe1);
        ...
        Athlete athlete42 = new Athlete("Faure", "Mathis", 'F', 11, 17, 7, france,  equipe1);
        handH.ajouterResultat(athlete42, new Score(14, 1,  athlete42));
        Athlete athlete43 = new Athlete("Fontaine", "Nathan", 'F', 17, 10, 2, france,  equipe1);
        ...
        Athlete athlete45 = new Athlete("Mercier", "Emma", 'F', 19, 19, 12, france,  equipe1);
        ...
        System.out.println(equipe1.getPlacement(handH));
